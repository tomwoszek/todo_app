...
///
/// See the documentation for Mockito's code generation for more information.
class MockTodoService extends _i1.Mock implements _i8.TodoService {
  @override
  _i4.Future<bool> createToDo(
    dynamic todoName,
    dynamic todoBeschreibung,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #createToDo,
  ...
  @override
  _i4.Future<bool> updateToDo(
    dynamic toDoId,
    dynamic newToDoName,
    dynamic newToDoBeschreibung,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #updateToDo,
  ...
  @override
  _i4.Future<bool> deleteToDo(dynamic toDoId) => (super.noSuchMethod(
        Invocation.method(
          #deleteToDo,
          [toDoId],
        ),
  ...
  @override
  _i4.Stream<_i9.QuerySnapshot<Object>> getToDos() => (super.noSuchMethod(
        Invocation.method(
          #getToDos,
          [],
        ),
...
/// A class which mocks [StoredatalocalService].
///
/// See the documentation for Mockito's code generation for more information.
class MockStoredatalocalService extends _i1.Mock
    implements _i10.StoredatalocalService {
  @override
  _i4.Future<dynamic> setToken(String? token) => (super.noSuchMethod(
        Invocation.method(
          #setToken,
          [token],
        ),
  ...
  @override
  _i4.Future<bool> deletAccessToken() => (super.noSuchMethod(
        Invocation.method(
          #deletAccessToken,
          [],
        ),
